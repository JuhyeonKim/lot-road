...
<div class="form-box" id="login-box">
	...
	<form action="${ctx}/j_security_check" method="post">
		...
		<div class="body bg-gray">
			...
			<div class="form-group">
				<input type="checkbox" name="remember_me" id="isSaveId"/> Remember me
			</div>
		</div>
		<div class="footer">
			...
			<a href="${ctx}/member/join" class="text-center">Register a new membership</a>
		</div>
	</form>
...
<c:set var="scripts" scope="request">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#loginForm').center();
			$('#userID').focus();
			if( $.cookie("saveId") && $.cookie("saveId") != ""){
				$("[name=j_username]").val($.cookie("saveId"));
			}

			$("#isSaveId").change(function(){
				var $this = $(this);
				if($this.is(":checked")){
					$.cookie("saveId",$("[name=j_username]").val());
				}
				/* else{
				 $.cookie("saveId",null,{path:'/'});
				 } */
			});
		});
	</script>
